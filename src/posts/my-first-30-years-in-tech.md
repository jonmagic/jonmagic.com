---
title: My First 30 Years in Tech
date: 2026-01-30
avatar: /images/posts/my-first-30-years-in-tech/orderedlist-octocat-with-vignettes.webp
tags:
  - post
description: >-
...
Everything changed in 2006 when Christian Metts—same friend from the VRcade days—introduced me to [Ruby on Rails](https://rubyonrails.org/). I went to the first RailsConf in Chicago that year and caught the programming bug. We started building software for SabreTech customers: a billing sync system for a chain of tanning salons, an obituary website called [Forever Remember Me](/posts/forever-remember-me/), internal tools for our own operations.
...
This was a big decision. I'd been an entrepreneur for fifteen years. The idea of working for someone else felt foreign. But with Natalie's support, I sold my share of SabreTech to my partners and [joined Ordered List](/posts/hey-mom-i-got-a-job/) in December 2010. Brandon Keepers joined a few weeks later, then Matt Graham a couple months after that.
...
GitHub noticed our products and our work. They made an offer to acquire Ordered List. On December 5th, 2011, [all five of us joined GitHub](/posts/githubber/). I became employee #50.
...
![orderedlist octocat with vignettes](/images/posts/my-first-30-years-in-tech/orderedlist-octocat-with-vignettes.webp)
