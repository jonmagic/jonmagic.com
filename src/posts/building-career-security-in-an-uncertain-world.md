---
layout: layout
title: Building Career Security in an Uncertain World
date: 2025-10-23
avatar: /images/posts/building-career-security-in-an-uncertain-world/walk-and-talk.webp
tags:
  - post
description: >-
...
The most important preparation isn't technical—it's relational. I wouldn't be at GitHub if I hadn't met [Steve Smith](https://orderedlist.com) and [John Nunemaker](https://johnnunemaker.com) at a small meetup at Notre Dame back in 2007. We kept in touch, built a friendship over three years, and in 2010 [they offered me a job](https://jonmagic.com/posts/hey-mom-i-got-a-job/) at Ordered List. A year later, when [GitHub acquired Ordered List](https://jonmagic.com/posts/githubber/), that entire relationship network came with me.
...
I learned the [SWOT analysis framework](https://en.wikipedia.org/wiki/SWOT_analysis) in college and [I've been using it ever since](https://jonmagic.com/posts/swot-analysis/). Every few months, I sit down with pen and paper and brutally assess my Strengths, Weaknesses, Opportunities, and Threats.

> [!NOTE]
> There are great alternatives to SWOT including SOAR (Strengths, Opportunities, Aspirations, Results), [Gap Analysis](https://en.wikipedia.org/wiki/Gap_analysis), and [Personal Balanced Scorecard](https://en.wikipedia.org/wiki/Balanced_scorecard).
...
- Write one blog post or tutorial (even a short one)
- Update your resume/portfolio with recent work
...
- Document your major accomplishments

**This year:**
- Go on at least 2-3 practice interviews
- Invest in your interview skills (prep courses, mock interviews, or practice platforms)
- Give one talk (even at a small meetup)
- Build one public project
- Find or strengthen one mentoring relationship
