...
It is early, experimental, and mostly built around my own workflow. It is useful if you run multiple agents and want a quieter way to know when one needs attention.
